...
<body class="bg-theme bg-theme1">
 ...
 <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <button class="add-catalog"><a href="site/insertsuatchieu.htm">Thêm Suat chieu</a></button> 
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
                <h5 class="card-title">Danh sách Suat chieu</h5>
                ${message }
                <div class="table-responsive">              
                  <table class="table table-striped"> 
                  <form:form action="site/suatchieu.htm" method="post" modelAttribute="suat_chieu">
                    <thead> 
                      <tr> 
                       
                        <th scope="col">Ma SC</th> 
                        <th scope="col">Gio bat dau va ket thuc </th>
                    ...
                    <tbody> 
                  <c:forEach items="${suat_chieus}" var="sc"> 
                      <tr> 
                        <td scope="row">${sc.ma_sc}</td> 
                        <td>${sc.gio_bat_dau_gio_ket_thuc}</td> 
        				<td>${sc.ngay_chieu }</td>
        				<td>${sc.phim.ten }</td> 
        				<td>${sc.phong_chieu.ten_pc }</td>
        				 <td> 
        				 <button class="btn btn-danger"><a href="site/suatchieu/${sc.ma_sc }.htm?linkDelete">Delete</a></button>
                         
                           <button  class="btn btn-success"><a href="site/suatchieu/${sc.ma_sc }.htm?linkEdit">Update</a></button>
                        </td> 
                     </tr> 
                    </c:forEach> 
                    </tbody>
