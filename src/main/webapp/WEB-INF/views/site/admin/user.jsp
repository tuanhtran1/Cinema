...
<body class="bg-theme bg-theme1">
 ...
 <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <button class="add-catalog"><a href="site/insertuser.htm">Thêm User</a></button> 
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
                ...
                <div class="table-responsive">              
                  ...
                  <form:form action="site/user.htm" method="post" modelAttribute="khach_hang">
                    <thead> 
                      <tr> 
                    ...
                    <tbody> 
                  <c:forEach items="${khach_hangs}" var="kh"> 
                      <tr> 
        				...
        				<td>${kh.ngay_sinh }</td> 
        				 <td> 
        				 <button class="btn btn-danger"><a href="site/user/${kh.ma_kh }.htm?linkDelete">Delete</a></button>
                         
                           <button  class="btn btn-success"><a href="site/user/${kh.ma_kh }.htm?linkEdit">Update</a></button>
                        </td> 
                     </tr> 
                    </c:forEach> 
                    </tbody>
