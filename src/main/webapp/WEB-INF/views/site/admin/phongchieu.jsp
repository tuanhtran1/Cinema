...
<body class="bg-theme bg-theme1">
 ...
 <div class="content-wrapper"> 
      <div class="container-fluid"> 
        ...
        <div class="row"> 
          <div class="col-lg-12"> 
            <button class="add-catalog"><a href="site/insertphongchieu.htm">Thêm Phong chieu</a></button> 
          </div> 
          <div class="col-lg-12"> 
            <div class="card"> 
              <div class="card-body"> 
                <h5 class="card-title">Danh sách Phong chieu</h5>
                ${message }
                <div class="table-responsive">              
                  <table class="table table-striped"> 
                  <form:form action="site/phongchieu.htm" method="post" modelAttribute="phong_chieu">
                    <thead> 
                      <tr> 
                       
                        <th scope="col">Ma PC</th> 
                        <th scope="col">Ten PC</th>
                        <th scope="col">So day ghe </th>
                        <th scope="col">So luong ghe </th>
                        <th scope="col">Mo ta  </th>
                        <th scope="col">Ma rap  </th>
                                             
                     </tr> 
                    </thead> 
                    <tbody> 
                  <c:forEach items="${phong_chieus}" var="pc"> 
                      <tr> 
                        <td scope="row">${pc.ma_pc}</td> 
                        <td>${pc.ten_pc}</td> 
        				<td>${pc.so_day_ghe}</td>
        				<td>${pc.so_luong_ghe }</td>
        				<td>${pc.mo_ta }</td>
        				<td>${pc.rap.ten_rap }</td> 
        				 <td> 
        				 <button class="btn btn-danger"><a href="site/phongchieu/${pc.ma_pc }.htm?linkDelete">Delete</a></button>
                         
                           <button  class="btn btn-success"><a href="site/phongchieu/${pc.ma_pc }.htm?linkEdit">Update</a></button>
                        </td> 
                     </tr> 
                    </c:forEach> 
                    </tbody>
