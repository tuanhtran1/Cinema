...
<head>
	...
	<link href="<c:url value='/resource/assets/css/style.css' />" rel="stylesheet" type="text/css" media="all" />
	<script src="<c:url value='/resource/assets/js/jquery-1.11.0.min.js' />"></script>
	<script src="<c:url value='/resource/assets/js/jquery.seat-charts.js' />"></script>
</head>
...
<div class="content">
	...
	<script type="text/javascript" src="<c:url value='/resource/assets/js/theme-change-seat-sel.js' />"></script>
	<script src="<c:url value='/resource/assets/js/jquery.nicescroll.js' />"></script>
	<script src="<c:url value='/resource/assets/js/scripts.js' />"></script>
</body>
